    ...
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Похоже, эта страница остыла. Вернитесь на главную — там всегда свежий кофе.
        </p>
        <div className="mt-8">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Мама варит кофе — кофейня на Покровке" },
      {
        name: "description",
        content: "Кофейня «Мама варит кофе» на Покровке, 8. Спешелти-кофе, десерты и уют.",
      },
